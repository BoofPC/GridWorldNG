...
public class LocationEditor extends PropertyEditorSupport {
  ...
  private final JFormattedTextField colField =
    new JFormattedTextField(NumberFormat.getIntegerInstance());
  ...
  public Object getValue() {
    final int row = ((Number) this.rowField.getValue()).intValue();
    final int col = ((Number) this.colField.getValue()).intValue();
  ...
  public void setValue(final Object newValue) {
    ...
    this.rowField.setValue(new Integer(loc.getRow()));
    this.colField.setValue(new Integer(loc.getCol()));
  }
