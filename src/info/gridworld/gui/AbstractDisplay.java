...
/**
 * This class provides common implementation code for drawing objects. It will translate, scale, and
 * rotate the graphics system as needed and then invoke its abstract <code>draw</code> method.
 * Subclasses of this abstract class define <code>draw</code> to display an object in a fixed size
 * and orientation. <br />
...
public abstract class AbstractDisplay implements Display {
  /**
   * Draw the given object. Subclasses should implement this method to draw the occupant facing
   * North in a cell of size (1,1) centered around (0,0) on the drawing surface. (All
   * scaling/rotating has been done beforehand).
   * 
  ...
  /**
   * Draw the given object. Scales and rotates the coordinate appropriately then invokes the simple
   * draw method above that is only responsible for drawing a unit-length occupant facing North.
   * 
   * @param obj the occupant we want to draw
   * @param comp the component on which to draw
   * @param g2 the graphics context
