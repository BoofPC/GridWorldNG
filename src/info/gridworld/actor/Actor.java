...
public class Actor {
   ...
   * 
   * @param newDirection the new direction. The direction of this actor is set to the angle between
   *          0 and 359 degrees that is equivalent to <code>newDirection</code>.
   */
  public void setDirection(final int newDirection) {
    this.direction = newDirection % Location.FULL_CIRCLE;
    if (this.direction < 0) {
   ...
   * 
   * @return the location of this actor, or <code>null</code> if this actor is not contained in a
   *         grid
   */
   ...
   * <br />
   * Precondition: (1) This actor is not contained in a grid (2) <code>loc</code> is valid in
   * <code>gr</code>
   * 
   * @param gr the grid into which this actor should be placed
   * @param loc the location into which the actor should be placed
   */
  public void putSelfInGrid(final Grid<Actor> gr, final Location loc) {
    if (this.grid != null) {
      throw new IllegalStateException(
        "This actor is already contained in a grid.");
    }
    final Actor actor = gr.get(loc);
    if (actor != null) {
   ...
   */
  public void moveTo(final Location newLocation) {
    if (this.grid == null) {
    ...
    this.grid.remove(this.location);
    final Actor other = this.grid.get(newLocation);
    if (other != null) {
  ...
  /**
   * Reverses the direction of this actor. Override this method in subclasses of <code>Actor</code>
