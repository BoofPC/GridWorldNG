...
/**
 * A <code>Rock</code> is an actor that does nothing. It is commonly used to block other actors from
 * moving. <br />
...
public class Rock extends Actor {
   ...
   */
  public Rock() {
    this.setColor(Rock.DEFAULT_COLOR);
  }
   ...
   */
  public Rock(final Color rockColor) {
    this.setColor(rockColor);
  }

  /**
   * Overrides the <code>act</code> method in the <code>Actor</code> class to do nothing.
   */
  @Override
  public void act() {}
}
